...
from malnis.models import Transformer
...
if full:
    epochs = 2000
    dim_feedforward = 50 * randint(2, 10)
    attention_heads = randint(2, 4)
    num_layers = randint(2, 4)
#     weight_decay = 0
...
# name = f"transformer_e{epochs}_h{dim_feedforward}_a{attention_heads}_l{num_layers}"
name = experiment_id
...
folder = "/home/jarobyte/scratch/malnis_dataset/transformer/specter/"
predictions_filename = folder + "predictions/" + name + ".npy"
train_log_filename = folder + "train_logs/" + name + ".pkl"
model_filename = folder + "models/" + name + ".pt"
